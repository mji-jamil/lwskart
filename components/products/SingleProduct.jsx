...
import SocialShare from "@/components/buttons/SocialShare";

export default async function SingleProduct({ product, dictionary,url }) {
    console.log(url);
            ...
            <div className="container grid grid-cols-2 gap-6 mb-8">
                ...
                <div>
                    ...
                    <div className="flex gap-3 mt-4">
                        <SocialShare title={product?.title} url={url}/>
                    </div>
